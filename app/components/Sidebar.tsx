...
const SECTION_ORDER: NavItemDef["section"][] = ["overview", "academics", "finance", "people", "system"];
...
export default function Sidebar({
  ...
  const SECTION_LABELS: Record<NavItemDef["section"], string> = {
    overview: t.nav.sectionOverview,
    academics: t.nav.sectionAcademics,
    finance: t.nav.sectionFinance,
    people: t.nav.sectionPeople,
    ...
    >
      ...
      <div className="px-6 py-5 border-b border-gray-800 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-sm font-bold flex-shrink-0 shadow-lg shadow-blue-900/30">
            O
          </div>
      ...
      <nav className="flex-1 px-3 py-4 overflow-y-auto">
        {groupedNav.map(({ section, items }, idx) => (
          <div key={section} className={idx > 0 ? "mt-5" : ""}>
            ...
            <div className="space-y-0.5">
              {items.map(({ href, labelKey, icon }) => {
                ...
                return (
                  ...
                  >
                    {isActive && (
                      <span className="absolute left-0 top-1.5 bottom-1.5 w-1 rounded-full bg-white/70" />
                    )}
                    {icon}
                    {label}
                  </Link>
      ...
      <div className="border-t border-gray-800 p-4 space-y-3">
        <div className="flex items-center gap-2 px-1">
          <div className="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center flex-shrink-0 text-xs font-bold text-gray-300 uppercase">
